<p align="center">
  <img src="docs/logo.svg" alt="DeepMyCode" width="640"/>
</p>
...
<p align="center">
  ...
   · 
  <a href="https://Brown226.github.io/DeepMyCode/">Website</a>
   · 
  <strong><a href="https://discord.gg/XF78rEME2D">Discord</a></strong>
</p>

> [!IMPORTANT]
> **DeepMyCode 1.0 is a ground-up rewrite in Go** — this branch (`main-v2`) is the new default and where development happens now.
> The earlier `0.x` TypeScript releases are **legacy**, living on the [`v1`](https://github.com/Brown226/DeepMyCode/tree/v1) branch (maintenance only).
> See the **[migration guide](./docs/MIGRATING.md)**. `npm i -g deepmycode` stays the install command — `1.0.0`+ delivers the Go binary, `0.x` is the legacy TS build.

<p align="center">
  <a href="https://www.npmjs.com/package/deepmycode"><img src="https://img.shields.io/npm/v/deepmycode.svg?style=flat-square&color=cb3837&labelColor=161b22&logo=npm&logoColor=white" alt="npm version"/></a>
  <a href="https://github.com/Brown226/DeepMyCode/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/Brown226/DeepMyCode/ci.yml?style=flat-square&label=ci&labelColor=161b22&logo=githubactions&logoColor=white" alt="CI"/></a>
  <a href="./LICENSE"><img src="https://img.shields.io/npm/l/deepmycode.svg?style=flat-square&color=8b949e&labelColor=161b22" alt="license"/></a>
  <a href="https://www.npmjs.com/package/deepmycode"><img src="https://img.shields.io/npm/dm/deepmycode.svg?style=flat-square&color=3fb950&labelColor=161b22&label=downloads" alt="downloads"/></a>
  <a href="https://github.com/Brown226/DeepMyCode/stargazers"><img src="https://img.shields.io/github/stars/Brown226/DeepMyCode.svg?style=flat-square&color=dbab09&labelColor=161b22&logo=github&logoColor=white" alt="GitHub stars"/></a>
  <a href="https://atomgit.com/Brown226/DeepMyCode"><img src="https://atomgit.com/Brown226/DeepMyCode/star/badge.svg" alt="AtomGit stars"/></a>
  <a href="https://github.com/Brown226/DeepMyCode/graphs/contributors"><img src="https://img.shields.io/github/contributors/Brown226/DeepMyCode.svg?style=flat-square&color=bc8cff&labelColor=161b22&logo=github&logoColor=white" alt="contributors"/></a>
  <a href="https://github.com/Brown226/DeepMyCode/discussions"><img src="https://img.shields.io/github/discussions/Brown226/DeepMyCode.svg?style=flat-square&color=58a6ff&labelColor=161b22&logo=github&logoColor=white" alt="Discussions"/></a>
  <a href="https://discord.gg/XF78rEME2D"><img src="https://img.shields.io/badge/discord-join-5865F2.svg?style=flat-square&labelColor=161b22&logo=discord&logoColor=white" alt="Discord"/></a>
</p>

<p align="center">
  <a href="https://oosmetrics.com/repo/Brown226/DeepMyCode"><img src="https://api.oosmetrics.com/api/v1/badge/achievement/9e931d80-2050-4b10-902e-44970cc133ad.svg" alt="oosmetrics — Top 2 in Agents by velocity"/></a>
  <a href="https://oosmetrics.com/repo/Brown226/DeepMyCode"><img src="https://api.oosmetrics.com/api/v1/badge/achievement/556d94b3-61b7-486b-baf2-888b9327deab.svg" alt="oosmetrics — Top 3 in LLMs by velocity"/></a>
  <a href="https://oosmetrics.com/repo/Brown226/DeepMyCode"><img src="https://api.oosmetrics.com/api/v1/badge/achievement/0f457d4c-efca-4d15-ad2b-139691ff342c.svg" alt="oosmetrics — Top 3 in CLI by velocity"/></a>
</p>
...
> [!IMPORTANT]
> **Community · 加入社区** — bilingual Discord for setup help (`#help` / `#求助`), workflow showcases, and feature ideas. → **[https://discord.gg/XF78rEME2D](https://discord.gg/XF78rEME2D)**
...
- **Config-driven.** Providers, the agent, enabled tools, and plugins are all
  declared in `deepmycode.toml`. No hardcoded models.
...
```sh
npm i -g deepmycode                  # any OS; pulls the prebuilt native binary
brew install Brown226/DeepMyCode/deepmycode   # macOS
```

Prebuilt archives (`darwin|linux|windows × amd64|arm64`) and `SHA256SUMS` are on
every [GitHub release](https://github.com/Brown226/DeepMyCode/releases).

### Build from source

```sh
make build      # -> bin/deepmycode(.exe)
...
```sh
deepmycode setup                      # config wizard → ./deepmycode.toml
export DEEPSEEK_API_KEY=sk-...  # or put it in .env (see .env.example)
deepmycode chat                       # then run /init to generate AGENTS.md (project memory)
...
Resolution order: **flag > `./deepmycode.toml` > `~/.config/deepmycode/config.toml` >
...
# language    = "zh"               # ui language; empty = auto-detect from $LANG / $DEEPMYCODE_LANG
...
[[plugins]]
name    = "example"
command = "deepmycode-plugin-example"
```

Permissions gate each tool call: `deny` > `ask` > `allow` > fallback (readers
always allow; writers fall back to `mode`). `deepmycode chat` prompts before writers
(`y` once · `a` this session · `n` no); `deepmycode run` stays autonomous but still
...
DeepMyCode is an MCP client. A `[[plugins]]` entry's `type` selects the transport:
...
exposes. `make build` also produces `bin/deepmycode-plugin-example` — a runnable
...
**Already have an `.mcp.json`?** Drop it in the project root and DeepMyCode
reads it as-is — the `mcpServers` spec (`command`/`args`/`env`, `type`/`url`/
`headers`, `${VAR}` expansion) maps field-for-field onto `[[plugins]]`. Both
sources are merged; on a name collision `deepmycode.toml` wins.
...
**Upgrading from `0.x`?** Your old `~/.deepmycode/config.json` is still read for its
`mcpServers` (honouring `mcpDisabled`) as a lowest-priority source, so MCP servers
keep working — move them into `deepmycode.toml`'s `[[plugins]]` or a `.mcp.json` when
convenient.

### Slash commands

In `deepmycode chat`, built-in commands (`/compact`, `/new`, `/rewind`, `/tree`,
...
`.deepmycode/commands/` (project) or `~/.config/deepmycode/commands/` (user) —
...
Embed `@` references in a message and DeepMyCode resolves them before sending, as
...
`deepmycode setup` keeps first-run minimal: pick provider → keys (every SKU of a
...
enter plan mode automatically: DeepMyCode first drafts a read-only plan, then waits
...
TOML config, an interactive `deepmycode setup` wizard, two-model collaboration
...
or a project `.mcp.json` — custom slash commands (`.deepmycode/commands/*.md`),
`@file` / `@resource` references, plus a runnable reference plugin
(`cmd/deepmycode-plugin-example`), the harness loop, and CLI. A Wails desktop
...
<a href="https://www.star-history.com/?repos=Brown226%2FDeepMyCode&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=Brown226/DeepMyCode&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=Brown226/DeepMyCode&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=Brown226/DeepMyCode&type=date&legend=top-left" />
 </picture>
</a>
...
If DeepMyCode has been useful and you'd like to say thanks, you can. It stays a coffee, not a contract — donations don't buy feature priority or change how issues get triaged.
...
A small list of folks whose work has shaped DeepMyCode the most — measured
by both commit count and code volume. **Listed alphabetically, no ordering
of importance.** The full contributor graph is on
[GitHub](https://github.com/Brown226/DeepMyCode/graphs/contributors).
...
<p align="center">
  <a href="https://github.com/Brown226/DeepMyCode/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=Brown226/DeepMyCode&max=100&columns=12" alt="Contributors to Brown226/DeepMyCode" width="860"/>
  </a>
</p>
...
<p align="center">
  ...
  <br/>
  <sub>Built by the community at <a href="https://github.com/Brown226/DeepMyCode/graphs/contributors">Brown226/DeepMyCode</a></sub>
</p>
