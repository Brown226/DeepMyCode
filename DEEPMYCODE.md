...
agent. It is the DeepMyCode analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `DEEPMYCODE.md` (this file, committed/shared), `DEEPMYCODE.local.md`
  (personal, git-ignored), user-global `~/.config/deepmycode/DEEPMYCODE.md`, and any
  `DEEPMYCODE.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
