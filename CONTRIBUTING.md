# Contributing to DeepMyCode

Thank you for your interest in contributing to DeepMyCode! This guide covers
...
```bash
git clone https://github.com/Brown226/DeepMyCode.git
cd DeepMyCode
go build ./cmd/deepmycode    # builds the CLI binary
...
| Directory | Purpose |
|-----------|---------|
| `cmd/deepmycode` | CLI entry point |
...
| `internal/memory` | DEEPMYCODE.md hierarchy + auto-memory |
