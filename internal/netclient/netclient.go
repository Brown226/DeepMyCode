// Package netclient builds HTTP clients that share DeepMyCode's user-facing proxy
...
// NewHTTPClient returns an HTTP client with DeepMyCode proxy settings applied.
