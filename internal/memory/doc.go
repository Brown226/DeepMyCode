// Package memory implements DeepMyCode's persistent memory. It mirrors Claude
// Code's two-layer model while honoring DeepMyCode's cache-first architecture:
//
//   - Hierarchical doc memory: DEEPMYCODE.md / AGENTS.md files discovered from the
...
const (
	ScopeUser     Scope = "user"     // ~/.config/deepmycode/DEEPMYCODE.md
	ScopeAncestor Scope = "ancestor" // a DEEPMYCODE.md above the project root
	ScopeProject  Scope = "project"  // ./DEEPMYCODE.md (committed, shared)
	ScopeLocal    Scope = "local"    // ./DEEPMYCODE.local.md (personal, git-ignored)
)

// docNames are the recognized memory filenames at each level, in load order.
// DEEPMYCODE.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
...
var docNames = []string{"DEEPMYCODE.md", "REASONIX.md", "AGENTS.md", "CLAUDE.md"}

// localNames are the personal, git-ignored overrides, highest precedence.
var localNames = []string{"DEEPMYCODE.local.md", "REASONIX.local.md", "AGENTS.local.md", "CLAUDE.local.md"}
