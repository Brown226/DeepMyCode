...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — DeepMyCode end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "deepmycode", "path to the deepmycode binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 DeepMyCode e2e benchmark\n\n")
